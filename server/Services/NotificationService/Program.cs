...
{
    throw new InvalidOperationException("ConnectionStrings:DefaultConnection is missing for NotificationService.");
}
...
{
    throw new InvalidOperationException("Jwt configuration is missing for NotificationService.");
}
